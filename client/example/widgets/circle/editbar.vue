<template>
	<div class="edit-bar circle" v-if="activeElement.uuid==parentID">
...
export default{
	...
	methods : {
		...
		editElement(e){
			this.$store.state.toolbarIndex = 8;
		},
		// z-index up
		upLayer(e){
...
<style>
	...
	.edit-bar.circle .menu-btn:hover,.edit-bar .menu-btn:focus{
		color: #ffffff;
	}
	.disable{
		color: #777777 !important;
	}
	.circle .primary-bar{width:240px;}
	.circle .third-bar{width:230px;}
	.circle .dropdown{
	    position: absolute;
	    width: 100px;
	    color: black;
